...
public class DanhSachHangHoa {
    ...
    public void duLieuMoi() throws ParseException {
        HangThucPham hangThucPham1 = new HangThucPham("tp01", "Rau", 10, 10000, consoleInput.ngayVN.parse("01/03/2022"), consoleInput.ngayVN.parse("11/11/2022"), "CTTNHH ...");
        HangThucPham hangThucPham2 = new HangThucPham("tp02", "Củ", 20, 20000, consoleInput.ngayVN.parse("02/03/2022"), consoleInput.ngayVN.parse("11/11/2022"), "CTTNHH ...");
        HangThucPham hangThucPham3 = new HangThucPham("tp03", "Quả", 30, 30000, consoleInput.ngayVN.parse("03/03/2022"), consoleInput.ngayVN.parse("11/11/2022"), "CTTNHH ...");
        HangThucPham hangThucPham4 = new HangThucPham("tp04", "Bột", 40, 10000, consoleInput.ngayVN.parse("04/03/2022"), consoleInput.ngayVN.parse("11/11/2022"), "CTTNHH ...");
        HangThucPham hangThucPham5 = new HangThucPham("tp05", "Gạo", 50, 20000, consoleInput.ngayVN.parse("05/03/2022"), consoleInput.ngayVN.parse("11/11/2022"), "CTTNHH ...");
        
        HangDienMay hangDienMay1 = new HangDienMay("dm01", "Nồi cơm điện", 1_000, 500_000, 12, 100);
        HangDienMay hangDienMay2 = new HangDienMay("dm02", "Ấm đun", 1_000, 100_000, 6, 100);
        HangDienMay hangDienMay3 = new HangDienMay("dm03", "Đèn", 1_000, 100_000, 6, 100);
        HangDienMay hangDienMay4 = new HangDienMay("dm04", "Quạt", 1_000, 400_000, 12, 65);
        HangDienMay hangDienMay5 = new HangDienMay("dm05", "Ổ cắm điện", 1_000, 100_000, 6, 50);
        

        HangSanhSu hangSanhSu1 = new HangSanhSu("ss01", "Chén", 5_000, 10_000, "CTTNHH ...", consoleInput.ngayVN.parse("20/03/2022"));
        HangSanhSu hangSanhSu2 = new HangSanhSu("ss02", "Chén kiểu", 5_000, 10_000, "CTTNHH ...", consoleInput.ngayVN.parse("20/03/2022"));
        HangSanhSu hangSanhSu3 = new HangSanhSu("ss03", "Ly", 5_000, 10_000, "CTTNHH ...", consoleInput.ngayVN.parse("20/03/2022"));
        HangSanhSu hangSanhSu4 = new HangSanhSu("ss04", "Tô", 5_000, 5_000, "CTTNHH ...", consoleInput.ngayVN.parse("20/03/2022"));
        HangSanhSu hangSanhSu5 = new HangSanhSu("ss05", "Muỗng", 5_000, 5_000, "CTTNHH ...", consoleInput.ngayVN.parse("20/03/2022"));
    ...
    public void suaHangHoaTheoMa() throws ParseException {
        KhoHang khoHang = null;
